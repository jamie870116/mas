...
def run_test(env, high_level_tasks, test_name, test_id, task_name=None):
    ...
    if task_name:
        ...
        save_to_video('logs/' + task_name.replace(" ", "_") + f"/FloorPlan209/test_{test_id}")
...
def plot_positions(points, show_hull=False):
    ...
    plt.scatter(x_coords, y_coords, c="blue", s=25, label="Positions")
    ...
    if show_hull and len(points) >= 3:
        ...
        plt.fill([points[i][0] for i in hull.vertices],
                 [points[i][1] for i in hull.vertices], 'r', alpha=0.1, label="Convex Hull")
...
if __name__ == "__main__":
    ...
    '''
    controller = ai2thor.controller.Controller(width=1000, height=1000, gridSize=0.25)
    env = AI2ThorEnv(controller, "config/config.json")
    ...
    contain_list = env.get_obj_in_containers()
    print("Object dictionary:", get_object_dict)
    print("Objects in containers:", contain_list)
    ...
    high_level_tasks = [
      [
        "NavigateTo(KeyChain_1)", "PickupObject(KeyChain_1)",
    # "NavigateTo(Cabinet_2)", "OpenObject(Cabinet_2)",
    # "NavigateTo(Cabinet_3)", "OpenObject(Cabinet_3)",
    # "NavigateTo(Cabinet_4)", "OpenObject(Cabinet_4)",
    # "NavigateTo(Cabinet_5)", "OpenObject(Cabinet_5)",
    # "NavigateTo(Cabinet_6)", "OpenObject(Cabinet_6)",
    # "NavigateTo(Cabinet_7)", "OpenObject(Cabinet_7)",
    # "NavigateTo(Cabinet_8)", "OpenObject(Cabinet_8)",
    # "NavigateTo(Cabinet_9)", "OpenObject(Cabinet_9)",
    # "NavigateTo(Cabinet_10)", "OpenObject(Cabinet_10)",
    # "NavigateTo(Cabinet_11)", "OpenObject(Cabinet_11)",
    # "NavigateTo(Cabinet_12)", "OpenObject(Cabinet_12)",
    # "NavigateTo(Cabinet_13)", "OpenObject(Cabinet_13)",
    # "NavigateTo(Cabinet_14)", "OpenObject(Cabinet_14)",
    # "NavigateTo(Cabinet_15)", "OpenObject(Cabinet_15)"
    ],
      [ "Idle",]
    ]
    ...
    #     task_name = task_name,
    # )
    # before_reachable_position_agent_0 = [(1.5, -1.5), (1.75, -1.5), (1.5, -1.25), (1.25, -1.5), (1.5, -1.75), (2.0, -1.5), (1.75, -1.25), (1.75, -1.75), (1.5, -1.0), (1.25, -1.25), (1.0, -1.5), (1.25, -1.75), (1.5, -2.0), (2.0, -1.25), (2.0, -1.75), (1.75, -1.0), (1.75, -2.0), (1.5, -0.75), (1.25, -1.0), (1.0, -1.25), (0.75, -1.5), (1.0, -1.75), (2.0, -1.0), (2.0, -2.0), (1.75, -0.75), (1.5, -0.5), (1.25, -0.75), (1.0, -1.0), (0.75, -1.25), (0.5, -1.5), (0.75, -1.75), (2.0, -0.75), (1.75, -0.5), (1.5, -0.25), (1.25, -0.5), (0.5, -1.25), (0.25, -1.5), (0.5, -1.75), (2.0, -0.5), (1.75, -0.25), (1.5, 0.0), (1.25, -0.25), (0.25, -1.25), (0.0, -1.5), (0.25, -1.75), (2.0, -0.25), (1.75, 0.0), (1.5, 0.25), (1.25, 0.0), (1.0, -0.25), (0.0, -1.25), (-0.25, -1.5), (0.0, -1.75), (2.0, 0.0), (1.75, 0.25), (1.5, 0.5), (1.25, 0.25), (1.0, 0.0), (-0.25, -1.25), (-0.5, -1.5), (-0.25, -1.75), (2.0, 0.25), (1.75, 0.5), (1.5, 0.75), (1.25, 0.5), (-0.5, -1.25), (-0.75, -1.5), (-0.5, -1.75), (2.0, 0.5), (1.75, 0.75), (1.5, 1.0), (1.25, 0.75), (-0.75, -1.25), (-1.0, -1.5), (-0.75, -1.75), (2.0, 0.75), (1.75, 1.0), (1.5, 1.25), (1.25, 1.0), (-1.0, -1.25), (-1.25, -1.5), (-1.0, -1.75), (2.0, 1.0), (1.75, 1.25), (1.5, 1.5), (1.25, 1.25), (-1.0, -1.0), (-1.25, -1.25), (-1.25, -1.75), (2.0, 1.25), (1.75, 1.5), (1.5, 1.75), (1.25, 1.5), (1.0, 1.25), (-1.0, -0.75), (-1.25, -1.0), (2.0, 1.5), (1.75, 1.75), (1.5, 2.0), (1.25, 1.75), (1.0, 1.5), (0.75, 1.25), (-1.0, -0.5), (-1.25, -0.75), (2.0, 1.75), (1.75, 2.0), (1.25, 2.0), (1.0, 1.75), (0.75, 1.5), (0.5, 1.25), (-1.0, -0.25), (-1.25, -0.5), (2.0, 2.0), (1.0, 2.0), (0.75, 1.75), (0.5, 1.5), (0.25, 1.25), (-1.0, 0.0), (-1.25, -0.25), (0.75, 2.0), (0.5, 1.75), (0.25, 1.5), (0.0, 1.25), (-1.0, 0.25), (-1.25, 0.0), (0.5, 2.0), (0.25, 1.75), (0.0, 1.5), (-0.25, 1.25), (-1.0, 0.5), (-1.25, 0.25), (0.25, 2.0), (0.0, 1.75), (-0.25, 1.5), (-0.5, 1.25), (-1.0, 0.75), (-1.25, 0.5), (0.0, 2.0), (-0.25, 1.75), (-0.5, 1.5), (-0.75, 1.25), (-1.0, 1.0), (-1.25, 0.75), (0.0, 2.25), (-0.25, 2.0), (-0.5, 1.75), (-0.75, 1.5), (-1.0, 1.25), (-1.25, 1.0), (-0.25, 2.25), (-0.5, 2.0), (-0.75, 1.75), (-1.0, 1.5), (-1.25, 1.25), (-0.75, 2.0), (-1.0, 1.75), (-1.25, 1.5), (-1.0, 2.0), (-1.25, 1.75), (-1.25, 2.0), (-1.5, 1.75), (-1.5, 2.0)]
    # final_reachable_position_agent_0 = [(-0.75, -1.5), (-0.75, -1.25), (-0.75, -1.75), (0.75, -1.5), (0.75, -1.25), (0.75, -1.75), (2.0, 2.0), (1.5, 2.0), (-1.0, -1.0), (-0.75, 1.25), (-0.75, 1.5), (-0.75, 1.75), (0.75, 1.25), (0.75, 1.5), (0.75, 1.75), (-1.25, -1.0), (-1.0, -0.75), (-1.0, -0.5), (-1.0, -0.25), (-1.0, 0.0), (-1.0, 0.25), (-1.0, 0.5), (-1.0, 0.75), (-1.25, -0.75), (0.5, -1.5), (0.5, -1.25), (0.5, -1.75), (-1.25, -0.5), (-1.25, -0.25), (-1.25, 0.0), (1.25, -1.5), (1.25, -1.25), (1.25, -1.75), (-1.0, 2.0), (1.75, -1.0), (1.75, -2.0), (0.0, 2.0), (0.0, 2.25), (1.5, -1.25), (1.5, -1.75), (1.5, -1.5), (0.5, 1.25), (0.5, 1.5), (0.5, 1.75), (-1.25, 2.0), (1.75, -0.75), (1.75, -0.5), (1.75, -0.25), (1.75, 0.0), (1.75, 0.25), (1.75, 0.5), (1.75, 0.75), (0.25, 2.0), (-0.5, -1.5), (-0.5, -1.25), (-0.5, -1.75), (1.5, 1.0), (1.5, 1.25), (1.5, 1.5), (1.5, 1.75), (1.75, 2.0), (-0.25, -1.5), (-0.25, -1.25), (-0.25, -1.75), (-0.5, 1.25), (-0.5, 1.5), (-0.5, 1.75), (1.0, -1.0), (-1.0, -1.5), (-1.0, -1.25), (-1.0, -1.75), (-1.5, 2.0), (-0.75, 2.0), (-0.25, 1.25), (-0.25, 1.5), (-0.25, 1.75), (1.0, -0.25), (1.0, 0.0), (1.25, 1.0), (1.25, 1.25), (1.25, 1.5), (1.25, 1.75), (0.25, -1.5), (0.25, -1.25), (0.25, -1.75), (1.0, 2.0), (2.0, 1.0), (2.0, 1.25), (2.0, 1.5), (2.0, 1.75), (1.0, 1.75), (0.5, 2.0), (1.75, 1.0), (1.75, 1.25), (1.75, 1.5), (1.75, 1.75), (0.75, 2.0), (0.0, -1.5), (0.0, -1.25), (0.0, -1.75), (-1.25, -1.5), (-1.25, -1.25), (-1.25, -1.75), (1.25, -1.0), (-1.5, 1.75), (-1.0, 1.0), (-1.0, 1.25), (-1.0, 1.5), (-1.0, 1.75), (1.25, 2.0), (-0.5, 2.0), (-1.25, 0.25), (-1.25, 0.5), (-1.25, 0.75), (1.0, -1.5), (1.0, -1.25), (1.0, -1.75), (2.0, -1.0), (2.0, -2.0), (0.0, 1.25), (0.0, 1.5), (0.0, 1.75), (1.5, -1.0), (1.5, -2.0), (-1.25, 1.0), (-1.25, 1.25), (-1.25, 1.5), (-1.25, 1.75), (1.25, -0.75), (1.25, -0.5), (1.25, -0.25), (1.25, 0.0), (1.25, 0.25), (1.25, 0.5), (1.25, 0.75), (-0.25, 2.0), (-0.25, 2.25), (0.25, 1.25), (0.25, 1.5), (0.25, 1.75), (1.0, 1.25), (1.0, 1.5), (2.0, -0.25), (2.0, 0.0), (2.0, 0.25), (2.0, 0.5), (2.0, 0.75), (2.0, -0.75), (2.0, -0.5), (1.5, -0.75), (1.5, -0.5), (1.5, -0.25), (1.5, 0.0), (1.5, 0.25), (1.5, 0.5), (1.5, 0.75)]
    
    # before_reachable_position_agent_1 = [(1.25, -1.5), (1.5, -1.5), (1.25, -1.25), (1.0, -1.5), (1.25, -1.75), (1.75, -1.5), (1.5, -1.25), (1.5, -1.75), (1.25, -1.0), (1.0, -1.25), (0.75, -1.5), (1.0, -1.75), (2.0, -1.5), (1.75, -1.25), (1.75, -1.75), (1.5, -1.0), (1.5, -2.0), (1.25, -0.75), (1.0, -1.0), (0.75, -1.25), (0.5, -1.5), (0.75, -1.75), (2.0, -1.25), (2.0, -1.75), (1.75, -1.0), (1.75, -2.0), (1.5, -0.75), (1.25, -0.5), (0.5, -1.25), (0.25, -1.5), (0.5, -1.75), (2.0, -1.0), (2.0, -2.0), (1.75, -0.75), (1.5, -0.5), (1.25, -0.25), (0.25, -1.25), (0.0, -1.5), (0.25, -1.75), (2.0, -0.75), (1.75, -0.5), (1.5, -0.25), (1.25, 0.0), (1.0, -0.25), (0.0, -1.25), (-0.25, -1.5), (0.0, -1.75), (2.0, -0.5), (1.75, -0.25), (1.5, 0.0), (1.25, 0.25), (1.0, 0.0), (-0.25, -1.25), (-0.5, -1.5), (-0.25, -1.75), (2.0, -0.25), (1.75, 0.0), (1.5, 0.25), (1.25, 0.5), (-0.5, -1.25), (-0.75, -1.5), (-0.5, -1.75), (2.0, 0.0), (1.75, 0.25), (1.5, 0.5), (1.25, 0.75), (-0.75, -1.25), (-1.0, -1.5), (-0.75, -1.75), (2.0, 0.25), (1.75, 0.5), (1.5, 0.75), (1.25, 1.0), (-1.0, -1.25), (-1.25, -1.5), (-1.0, -1.75), (2.0, 0.5), (1.75, 0.75), (1.5, 1.0), (1.25, 1.25), (-1.0, -1.0), (-1.25, -1.25), (-1.25, -1.75), (2.0, 0.75), (1.75, 1.0), (1.5, 1.25), (1.25, 1.5), (1.0, 1.25), (-1.0, -0.75), (-1.25, -1.0), (2.0, 1.0), (1.75, 1.25), (1.5, 1.5), (1.25, 1.75), (1.0, 1.5), (0.75, 1.25), (-1.0, -0.5), (-1.25, -0.75), (2.0, 1.25), (1.75, 1.5), (1.5, 1.75), (1.25, 2.0), (1.0, 1.75), (0.75, 1.5), (0.5, 1.25), (-1.0, -0.25), (-1.25, -0.5), (2.0, 1.5), (1.75, 1.75), (1.5, 2.0), (1.0, 2.0), (0.75, 1.75), (0.5, 1.5), (0.25, 1.25), (-1.0, 0.0), (-1.25, -0.25), (2.0, 1.75), (1.75, 2.0), (0.75, 2.0), (0.5, 1.75), (0.25, 1.5), (0.0, 1.25), (-1.0, 0.25), (-1.25, 0.0), (2.0, 2.0), (0.5, 2.0), (0.25, 1.75), (0.0, 1.5), (-0.25, 1.25), (-1.0, 0.5), (-1.25, 0.25), (0.25, 2.0), (0.0, 1.75), (-0.25, 1.5), (-0.5, 1.25), (-1.0, 0.75), (-1.25, 0.5), (0.0, 2.0), (-0.25, 1.75), (-0.5, 1.5), (-0.75, 1.25), (-1.0, 1.0), (-1.25, 0.75), (0.0, 2.25), (-0.25, 2.0), (-0.5, 1.75), (-0.75, 1.5), (-1.0, 1.25), (-1.25, 1.0), (-0.25, 2.25), (-0.5, 2.0), (-0.75, 1.75), (-1.0, 1.5), (-1.25, 1.25), (-0.75, 2.0), (-1.0, 1.75), (-1.25, 1.5), (-1.0, 2.0), (-1.25, 1.75), (-1.25, 2.0), (-1.5, 1.75), (-1.5, 2.0)]
    # final_reachable_position_agent_1 = [(-0.75, -1.5), (-0.75, -1.25), (-0.75, -1.75), (0.75, -1.5), (0.75, -1.25), (0.75, -1.75), (2.0, 2.0), (1.5, 2.0), (-1.0, -1.0), (-0.75, 1.25), (-0.75, 1.5), (-0.75, 1.75), (0.75, 1.25), (0.75, 1.5), (0.75, 1.75), (-1.25, -1.0), (-1.0, -0.75), (-1.0, -0.5), (-1.0, -0.25), (-1.0, 0.0), (-1.0, 0.25), (-1.0, 0.5), (-1.0, 0.75), (-1.25, -0.75), (0.5, -1.5), (0.5, -1.25), (0.5, -1.75), (-1.25, -0.5), (-1.25, -0.25), (-1.25, 0.0), (-1.0, 2.0), (1.75, -2.0), (1.75, -1.0), (0.0, 2.0), (0.0, 2.25), (0.5, 1.25), (0.5, 1.5), (0.5, 1.75), (-1.25, 2.0), (1.75, -0.75), (1.75, -0.5), (1.75, -0.25), (1.75, 0.0), (1.75, 0.25), (1.75, 0.5), (1.75, 0.75), (0.25, 2.0), (-0.5, -1.5), (-0.5, -1.25), (-0.5, -1.75), (1.5, 1.0), (1.5, 1.25), (1.5, 1.5), (1.5, 1.75), (1.75, 2.0), (-0.25, -1.5), (-0.25, -1.25), (-0.25, -1.75), (-0.5, 1.25), (-0.5, 1.5), (-0.5, 1.75), (1.0, -1.0), (-1.0, -1.25), (-1.0, -1.75), (-1.0, -1.5), (-1.5, 2.0), (-0.75, 2.0), (-0.25, 1.25), (-0.25, 1.5), (2.0, 0.75), (-0.25, 1.75), (1.0, -0.25), (1.0, 0.0), (2.0, -1.5), (2.0, -1.25), (2.0, -1.75), (1.25, 1.0), (1.25, 1.25), (1.25, 1.5), (1.25, 1.75), (0.25, -1.5), (0.25, -1.25), (0.25, -1.75), (1.0, 2.0), (2.0, 1.0), (2.0, 1.25), (2.0, 1.5), (2.0, 1.75), (1.75, -1.5), (1.75, -1.25), (1.75, -1.75), (1.0, 1.75), (0.5, 2.0), (1.75, 1.0), (1.75, 1.25), (1.75, 1.5), (1.75, 1.75), (0.75, 2.0), (0.0, -1.5), (0.0, -1.25), (0.0, -1.75), (-1.25, -1.5), (-1.25, -1.25), (-1.25, -1.75), (1.25, -1.0), (-1.5, 1.75), (-1.0, 1.0), (-1.0, 1.25), (-1.0, 1.5), (-1.0, 1.75), (-0.5, 2.0), (-1.25, 0.25), (-1.25, 0.5), (-1.25, 0.75), (2.0, -1.0), (2.0, -2.0), (0.0, 1.25), (0.0, 1.5), (0.0, 1.75), (1.5, -1.0), (1.5, -2.0), (-1.25, 1.0), (-1.25, 1.25), (-1.25, 1.5), (-1.25, 1.75), (1.25, -0.75), (1.25, -0.5), (1.25, -0.25), (1.25, 0.0), (1.25, 0.25), (1.25, 0.5), (1.25, 0.75), (-0.25, 2.0), (-0.25, 2.25), (0.25, 1.25), (0.25, 1.5), (0.25, 1.75), (1.0, 1.25), (1.0, 1.5), (2.0, -0.25), (2.0, 0.0), (2.0, 0.25), (2.0, 0.5), (2.0, -0.75), (2.0, -0.5), (1.5, -0.75), (1.5, -0.5), (1.5, -0.25), (1.5, 0.0), (1.5, 0.25), (1.5, 0.5), (1.5, 0.75), (1.25, 2.0)]
    ...
    #     zs = [z for x, z in points]
    #     return xs, zs

    # # Agent 0
    # a0_before_x, a0_before_z = split_xz(before_reachable_position_agent_0)
    # a0_after_x,  a0_after_z  = split_xz(final_reachable_position_agent_0)

    # # Agent 1
    # a1_before_x, a1_before_z = split_xz(before_reachable_position_agent_1)
    # a1_after_x,  a1_after_z  = split_xz(final_reachable_position_agent_1)

    # fig, axs = plt.subplots(2, 2, figsize=(16, 14))

    # # (0,0) Agent0 Before
    # axs[0, 0].scatter(a0_before_x, a0_before_z, s=35, alpha=0.7)
    # axs[0, 0].set_title("Agent 0 - Before")
    ...
    # # (0,1) Agent0 After
    # axs[0, 1].scatter(a0_after_x, a0_after_z, s=35, alpha=0.7)
    # axs[0, 1].set_title("Agent 0 - After")
    ...
    # # (1,0) Agent1 Before
    # axs[1, 0].scatter(a1_before_x, a1_before_z, s=35, alpha=0.7)
    # axs[1, 0].set_title("Agent 1 - Before")
    ...
    # # (1,1) Agent1 After
    # axs[1, 1].scatter(a1_after_x, a1_after_z, s=35, alpha=0.7)
    # axs[1, 1].set_title("Agent 1 - After")
    ...
    # plt.show()
        ...
        # 提取 x, z 座標
    # before_x = [x for x, z in before_reachable_position_agent_1]
    # before_z = [z for x, z in before_reachable_position_agent_1]

    # after_x = [x for x, z in final_reachable_position_agent_1]
    # after_z = [z for x, z in final_reachable_position_agent_1]
    # # 建立圖表與子圖
