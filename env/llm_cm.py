...
if __name__ == "__main__":
    ...
    TASKS_4 = [
    {
        ...
        "scenes": [ "FloorPlan202","FloorPlan203","FloorPlan209", ] #"FloorPlan212" hen"FloorPlan201"
    },
    {
    ...
    batch_run(TASKS_1, base_dir="config", start=4, end=5, sleep_after=50, delete_frames=True)
